package com.app.tradingplatform.dao;
 ...
 * @see com.app.tradingplatform.domain.User
	...
	public User findById(int id) {
		...
		try {
			User instance = (User) sessionFactory.getCurrentSession().get(
					"com.app.tradingplatform.domain.User", id);
			if (instance == null) {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.app.tradingplatform.domain.User")
